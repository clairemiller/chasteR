...
{
  # Initial less efficient read method:
  # con <- file(paste(filepath,filename,sep="/"),"r")
  # dat <- readLines(con)
  # close(con)
...
#' @export
readCellLocations<-function(filepath,num_dims=2)
{
...
#' @export
readCellData<-function(filepath,var_name, dimensions = 2)
{
